...
public class SearchLostItemActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search_lost_item);
        ...
        searchButton.setOnClickListener(v -> searchLostItem());
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (!itemFound) {
                                Toast.makeText(SearchLostItemActivity.this,
                                        "No Lost Item found with this name",
